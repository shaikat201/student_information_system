...
<br />
<br />
<table align="center" cellpadding="0" bgcolor="#00FFFF" width="95%" border="5" BORDERCOLOR=#0099ff>
  <tr>
...
while($result=mysql_fetch_array($resource))
	...
	<td>".$result[14]."</td>
	<td>
	<a href=\"modify2.php?roll=".$result[0]."\"><img border=\"0\" src=\"images/cooltext457953689.png\"/></a>
	</td>
	</tr>";
	} echo "</table>";
	 ?>
